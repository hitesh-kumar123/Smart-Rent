    ...
    const fetchProperties = async () => {
      ...
      try {
        ...
        if (propertyTypeParam) {
          ...
          queryString += `propertyType=${mapCategoryToPropertyType(propertyTypeParam)}`;
        }

        // Log request details
        console.log("Making API request to:", `http://localhost:8000/api/properties${queryString ? `?${queryString}` : ""}`);
